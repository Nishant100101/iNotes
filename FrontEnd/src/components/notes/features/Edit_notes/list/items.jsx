  ...
  return (
    ...
    >
      {isFakeInput ? (
        ...
        <>
          <span className="ml-1 text-base flex justify-center text-slate-950 items-start pt-1 px-2 font-semibold">
            {id + 1}.
          </span>
          ...
          <div className="flex items-center w-full">
            <textarea
              ...
              spellCheck="false"
              onInput={(e) => {
                isEdited && handleInput(e);
              }}
              className={`outline-none custom-wrapper h-auto overflow-hidden resize-none w-full custom-wrapper font-normal bg-transparent text-slate-950 text-base`}
            />
          </div>
